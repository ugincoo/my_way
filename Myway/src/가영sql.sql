...
insert into member (member_id, member_pw, member_phone, member_name) values ( 'qwe' , 1234, '010-9999-9999', '김미영');
insert into member (member_id, member_pw, member_phone, member_name) values ( 'asd' , 1111, '010-1111-1111', '권가영');
insert into member (member_id, member_pw, member_phone, member_name) values ( 'zxc' , 0000, '010-8888-8888', '백한결');
insert into member (member_id, member_pw, member_phone, member_name) values ( 'cvb' , 2222, '010-7777-7777', '오유진');
...
insert into bcommend (bcomm_content, member_no, recom_no) values ('솔직히 저는 이것만 먹어욥!',5, 1);
insert into bcommend (bcomm_content, member_no, recom_no) values ('오~ 맛있겠다:) 다음엔 이거 시켜먹어야지~',2, 1);
insert into bcommend (bcomm_content, member_no, recom_no) values ('굳굳!',5, 2);
...
insert into porder (member_no, bread_no, drink_no, veg_no, source_no, che_no, meat_no, o_status, price) values (2, 1, 32, 18, 23, 9, 14, 1, 6200);
insert into porder (member_no, bread_no, drink_no, veg_no, source_no, che_no, meat_no, o_status, price) values (2, 1, 32, 18, 23, 9, 14, 1, 6200);
...
-- DB 추가
insert into member (member_no, member_id,member_pw, member_phones, member_name) values (0, 'admin' , 1, '010-0000-0000', '관리자'); -- 관리자
